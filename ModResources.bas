...
' =============================================================================
' Module Name:      ModResources
' Module Type:      Code Module
' Description:      Resource code and API calls; used mainly to compile with
'                   a standard icon for the application.
' Author(s):        http://VBAccelerator.com (modified by Jonathan A. Conway)
' -----------------------------------------------------------------------------
' Log:
'                   ?? ?? ?? : Got code from VBAccelerator website, made
'                              made changes then created ModResources
' =============================================================================
