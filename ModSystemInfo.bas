...
' =============================================================================
' Module Name:      ModSystemInfo
' Module Type:      Code Module
' Description:      Load up the System Information dialog
' Author(s):        Visual Basic Wizard (modified by Jonathan A. Conway)
' -----------------------------------------------------------------------------
' Log:
'                   ?? ?? ?? : Generated the code with a VB Wizard and
